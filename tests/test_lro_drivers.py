...
from pfeffernusse.drivers import lro_driver, base, distortion
from pfeffernusse.drivers.lro_driver import LRO_LROC
...
def test_lro_as_pfeffer_isd(lro_lroclabel):
    with LRO_LROC(lro_lroclabel) as m:
