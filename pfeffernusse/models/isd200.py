...
from pfeffernusse.models.isd200_optical_distortion import ISD200OpticalDistortion  # noqa: F401,E501
...
class ISD200(Model):
    ...
    def __init__(self, detector_center: ISD200DetectorCenter=None, center_ephemeris_time: float=None, starting_ephemeris_time: float=None, focal_length_model: ISD200FocalLengthModel=None, image_lines: float=None, image_samples: float=None, radii: ISD200Radii=None, optical_distortion: ISD200OpticalDistortion=None, starting_detector_sample: float=None, starting_detector_line: float=None, focal2pixel_samples: List[float]=None, focal2pixel_lines: List[float]=None, sensor_location: List[XYZ]=None, sensor_velocity: List[XYZ]=None, sun_position: List[XYZ]=None, sun_velocity: List[XYZ]=None, sensor_orientation: List[Quaternion]=None, line_scan_rate: List[List[float]]=None, detector_sample_summing: float=None, detector_line_summing: float=None, apply_light_time_correction: bool=None, number_of_ephemerides: float=None, number_of_quaternions: float=None, dt_ephemeris: float=None, t0_ephemeris: float=None, dt_quaternion: float=None, t0_quaternion: float=None, reference_height: ISD200ReferenceHeight=None, interpolation_method: str=None):  # noqa: E501
        ...
        :type optical_distortion: ISD200OpticalDistortion
        ...
        self.openapi_types = {
            ...
            'image_samples': float,
            'radii': ISD200Radii,
            'optical_distortion': ISD200OpticalDistortion,
    ...
    @property
    def optical_distortion(self) -> ISD200OpticalDistortion:
    ...
    def optical_distortion(self, optical_distortion: ISD200OpticalDistortion):
