...
class ISD200FocalLengthModel(Model):
    ...
    def __init__(self, key: str=None, focal_length: float=None, focal_epsilon: float=None, units: str=None):  # noqa: E501
        ...
        :param units: The units of this ISD200FocalLengthModel.  # noqa: E501
        :type units: str
        """
        self.openapi_types = {
            'key': str,
    ...
    @property
    def units(self) -> str:
        """Gets the units of this ISD200FocalLengthModel.


        :return: The units of this ISD200FocalLengthModel.
        :rtype: str
        """
        return self._units
    ...
    def units(self, units: str):
        """Sets the units of this ISD200FocalLengthModel.


        :param units: The units of this ISD200FocalLengthModel.
        :type units: str
        """
